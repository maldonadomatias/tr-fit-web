...
export function RegenSkeletonDialog({
  alert,
  onClose,
}: {
  alert: CoachAlert;
  ...
  return (
    <Dialog open onOpenChange={(o) => !o && onClose()}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Regenerar rutina (AI)</DialogTitle>
        </DialogHeader>
        <p className="text-sm text-destructive">
          Sustituye el skeleton activo del atleta. Acción irreversible sin
          backup manual.
        </p>
        <Textarea
          placeholder="Razón (opcional, se guarda en audit)"
          value={reason}
