...
export function ContactNoteDialog({
  ...
  return (
    <Dialog open onOpenChange={(o) => !o && onClose()}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Contactar atleta + nota interna</DialogTitle>
        </DialogHeader>
        <p className="text-sm text-muted-foreground">
          No se manda mensaje al atleta. Contactá por WhatsApp/email externo.
          Esta nota queda en audit.
        </p>
        <Textarea
          placeholder="Qué hablaste / decisión que tomaste fuera del sistema"
          value={note}
