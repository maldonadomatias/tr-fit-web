  ...
  return (
    ...
    >
      <p>
        ...
        Servicio aceptás estos Términos. Si no estás de acuerdo, no uses el
        Servicio.
      </p>
      ...
      <ul>
        <li>
          Debés ser mayor de 16 años para crear una cuenta. Los menores de edad
          requieren consentimiento de su tutor.
        </li>
        <li>
          Sos responsable de la veracidad de los datos provistos y de mantener
          la confidencialidad de tu contraseña.
        </li>
        <li>
          Todas las acciones realizadas desde tu cuenta se consideran hechas por
          vos.
        </li>
        <li>
          Las cuentas nuevas requieren aprobación administrativa antes de tener
          acceso pleno al Servicio.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          Utilizar el Servicio para fines ilícitos o que vulneren derechos de
          terceros.
        </li>
        <li>
          Intentar acceder a sistemas, datos o cuentas que no te pertenezcan.
        </li>
        <li>
          Realizar ingeniería inversa, copiar, modificar o redistribuir el
          Servicio.
        </li>
        <li>
          Cargar contenido falso, malicioso o que pueda dañar el funcionamiento
          del Servicio.
        </li>
        <li>
          Automatizar el acceso (scrapers, bots) sin autorización escrita.
        </li>
      </ul>
      ...
      <p>
        ...
        lesiones o si estás embarazada. Suspendé inmediatamente cualquier
        actividad ante dolor o malestar y buscá atención profesional. Usás el
      ...
      <p>
        ...
        menos 15 días de anticipación. El uso continuado del Servicio luego de
      ...
      <p>
        ...
        los tribunales ordinarios de la Provincia de Tucumán, con renuncia a
