...
export const principal: Record<number, PrincipalCfg> = {
  ...
  13: { series: 3, reps: '6 a 8',  descanso: '3 min', pct: 0.65, rmSource: 10 },
  14: { series: 3, reps: '5',      descanso: '3 min', pct: 0.77, rmSource: 10 },
  15: { series: 4, reps: '4',      descanso: '3 min', pct: 0.80, rmSource: 10 },
  16: { series: 4, reps: '3',      descanso: '3 min',     pct: 0.82, rmSource: 10 },
  17: { series: 3, reps: '3',      descanso: '3 min',     pct: 0.85, rmSource: 10 },
  18: { series: 2, reps: '2 a 3',  descanso: '3 min', pct: 0.80, rmSource: 10, isDeload: true },
  19: { series: 3, reps: '3',      descanso: '3 min',     pct: 0.88, rmSource: 10 },
  20: { series: 1, reps: 'AMRAP',  descanso: '5 min', pct: 0.85, rmSource: 10, isAmrap: true },
  21: { series: 3, reps: '6',      descanso: '3 min', pct: 0.75, rmSource: 20 },
  22: { series: 3, reps: '6',      descanso: '3 min', pct: 0.77, rmSource: 20 },
  23: { series: 3, reps: '6 a 8',  descanso: '3 min', pct: 0.70, rmSource: 20 },
  24: { series: 3, reps: '6',      descanso: '3 min', pct: 0.78, rmSource: 20 },
  25: { series: 3, reps: '4',      descanso: '3 min',     pct: 0.80, rmSource: 20 },
  26: { series: 3, reps: '3',      descanso: '3 min',     pct: 0.83, rmSource: 20 },
  27: { series: 2, reps: '2 a 3',  descanso: '3 min', pct: 0.80, rmSource: 20, isDeload: true },
  28: { series: 3, reps: '6 a 8',  descanso: '3 min', pct: 0.75, rmSource: 20 },
  29: { series: 2, reps: '3',      descanso: '5 min', pct: 0.72, rmSource: 20, isDeload: true },
  30: { series: 1, reps: '1',      descanso: '5 min', isRmTest: true },
};
